      ...
      {showJitsi ? (
        ...
        <div>
            ...
            {user.selectContact ? (
              ...
              >
                <div style={{ display: "flex" }}>
                  {user.selectContact.imageProfile ? (
                    <img
                  ...
                  <Typography
                    variant="h5"
                    style={{ color: teal[900], marginTop: 10 }}
                  >
          ...
          >
            ...
            {chat.map((m, i) => (
              <Box key={i}>
                {(m.reciver === userSender.user.email ||
                  userSender.user.email === m.sender) &&
                (m.sender === user.selectContact.email ||
